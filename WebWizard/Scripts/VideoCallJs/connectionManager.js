var WebWizard = WebWizard || {};

/************************************************
ConnectionManager.js

Implements WebWizard connectivity for sharing video
streams, and surfaces functionality to the rest
of the app.

WebWizard API has been normalized using 'adapter.js'

************************************************/
WebWizard.ConnectionManager = (function () {
    var _signaler,
        _connections = {},
        ...
        _receivedSdpSignal = function (connection, partnerClientId, sdp) {
            console.log('WebWizard: processing sdp signal');
            connection.setRemoteDescription(new RTCSessionDescription(sdp), function () {
                if (connection.remoteDescription.type == "offer") {
                    console.log('WebWizard: received offer, sending response...');
                    ...
                    console.log('WebWizard: received answer');
                }
            });
        },
        ...
        _receivedCandidateSignal = function (connection, partnerClientId, candidate) {
            console.log('WebWizard: processing candidate signal');
