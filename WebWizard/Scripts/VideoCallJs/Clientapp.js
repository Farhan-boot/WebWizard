...
function UserMediaPer(audio, video) {
...
WebWizard.App = (function (viewModel, connectionManager) {
    var _mediaStream,
        _hub,
        ...
        _connect = function(username, onSuccess, onFailure) {
            ...
            var hub = $.connection.videoChatHub;
    ...
    $.ajax({
        ...
        success: function (response) {
            _startSession(response.ClientRegistration.FirstName + " " + response.ClientRegistration.LastName);
            // alert(response);
        ...
        _setupHubCallbacks = function (hub) {
           // var audio = new Audio('/Assets/VideoCallAssets/music/ringtone.mp3');
...
})(WebWizard.ViewModel, WebWizard.ConnectionManager);
