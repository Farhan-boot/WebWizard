var app = angular.module('SearchWebWizardApp', []);
app.controller('SearchWebWizardCtrl', function ($scope, $http) {
    ...
    $scope.getData = function (pageno, Name) {
        ...
        if ($scope.PageNumber <= 0) {
            ...
            $http.post('/Search/GetWebWizardListForSearch', $scope.SearchController).then(function (getWebWizardList) {
