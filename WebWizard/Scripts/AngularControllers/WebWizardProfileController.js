var app = angular.module('WebWizardProfileApp', ['ui.bootstrap', 'ngImgCrop', 'ngSanitize', 'ngRoute']);

app.controller('WebWizardProfileCtrl', function ($scope, $http, $filter, $uibModal, $log, $location) {
    //alert("jesy");
